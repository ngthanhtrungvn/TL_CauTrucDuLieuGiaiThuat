...
void chuyenThanhPostFix(char *bieuThuc, char *str)
{
	Stack s;
	initStack(s);
	int j = 0;
...
void main()
{
	...
	printf("Nhap vao bieu thuc ban muon chuyen: ");
	scanf("%s", &bieuthuc);
	chuyenThanhPostFix(bieuthuc, str);
	printf("Bieu thuc sau khi chuyen thanh hau to: %s", str);
	getch();
}